// Auto-generated from @ra9/tan-compose-icons (icons-v0.2.0) source — official ICONS data + tc-icon.
export const ICONS = {
  // alerts / status
  "alert-circle":
  ...
  "edit":
    `<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="m18.5 2.5 a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4Z"/>`,
  "trash":
  ...
  "receipt":
    `<path d="M4 3a1 1 0 0 1 1-1 1.3 1.3 0 0 1 .7.2l.933.6a1.3 1.3 0 0 0 1.4 0l.934-.6a1.3 1.3 0 0 1 1.4 0l.933.6a1.3 1.3 0 0 0 1.4 0l.933-.6a1.3 1.3 0 0 1 1.4 0l.934.6a1.3 1.3 0 0 0 1.4 0l.933-.6A1.3 1.3 0 0 1 19 2a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1 1.3 1.3 0 0 1-.7-.2l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.934.6a1.3 1.3 0 0 1-1.4 0l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-1.4 0l-.934-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-.7.2 1 1 0 0 1-1-1z"/><path d="M16 8h-6a2 2 0 0 0 0 4h4a2 2 0 0 1 0 4H8"/><path d="M12 17V7"/>`,
  "wallet":
...
// ── <tc-icon> — official component (ports @ra9/tan-compose-icons/mod.ts) ──
import { build, describe } from "https://cdn.jsdelivr.net/gh/RA9/tan-compose@1.3.0/dist/mod.js";
...
build("tc-icon", describe({
  ...
  template: ({ props }) => {
    ...
    if (!path) {
      return `<svg width="${esc(size)}" height="${esc(size)}" viewBox="0 0 24 24"
        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
        stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/>
        <text x="12" y="14.5" text-anchor="middle" font-size="6" font-family="monospace"
        stroke="none" fill="currentColor">?</text></svg>`;
    }
    const ariaProps = title ? `role="img" aria-label="${esc(title)}"` : `aria-hidden="true"`;
    return `<svg width="${esc(size)}" height="${esc(size)}" viewBox="0 0 24 24"
      fill="${esc(fill)}" stroke="${esc(stroke)}" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round" ${ariaProps}>${title ? `<title>${esc(title)}</title>` : ""}${path}</svg>`;
  },
}));
